...
public class EnergyData extends CarbonCalculator{
    ...
    public static final double carbonPerKWh = 0.00025;
    public static final double carbonPerKWhRenewable = 0.00002;
    ...
    public void calculateCarbonFootprint() {
        ...
        totalCarbonFootprint = (energyUsage * carbonPerKWh) + (renewableEnergyUsage * carbonPerKWhRenewable);
    }
}
